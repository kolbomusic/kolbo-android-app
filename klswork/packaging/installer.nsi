...
BrandingText "Kolbo Live Studio - Preview 0.2.0"
VIProductVersion "0.2.0.0"
VIAddVersionKey "ProductName" "Kolbo Live Studio"
VIAddVersionKey "FileDescription" "Kolbo Live Studio Preview Installer"
VIAddVersionKey "FileVersion" "0.2.0-preview"
VIAddVersionKey "LegalCopyright" "Kolbo Live Studio contributors"

!define MUI_ABORTWARNING
!define MUI_WELCOMEPAGE_TITLE "Kolbo Live Studio"
!define MUI_WELCOMEPAGE_TEXT "Live browser phone camera with secure HTTPS pairing, audio/karaoke-video/YouTube playback, live microphone/playback balance, visible export progress and MR816X REV-X validation. Recordings are stored separately and are not deleted during uninstall."
...
Section "Kolbo Live Studio"
  ...
  FileWrite $0 "Kolbo Live Studio Preview 0.2.0"
  FileClose $0
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\KolboLiveStudio" "DisplayVersion" "0.2.0-preview"
